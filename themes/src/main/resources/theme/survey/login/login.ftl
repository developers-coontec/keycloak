...
<#--                </#list>-->
      ...
      <div class="survey_content_links">
        ...
        <div class="survey_content_link_group margin-top-32">
          ...
          <div class="survey_login_forgot_id survey_link_text margin-left-20"
               onclick="goToUrl('${url.loginFindEmailUrl}')">
            <span>${msg("login-content-forgot-id")}</span>
          </div>
          <div class="survey_login_forgot_password survey_link_text margin-left-20"
        ...
        <div class="survey_content_link_group">
          ...
          <div class="survey_login_register survey_link_text margin-left-20"
